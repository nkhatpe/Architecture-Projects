...
typedef struct APEX_CPU
{
    ...
    int forward_reg[REG_FILE_SIZE];
    int forward_flag[REG_FILE_SIZE];
    int stall;
    int scoreboard[REG_FILE_SIZE];  // Scoreboard to track register availability
...
void print_reg_file(const APEX_CPU *cpu);
